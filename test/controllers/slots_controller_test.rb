...
class SlotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create slot" do
    assert_difference('Slot.count') do
      post slots_url, params: { slot: { number: @slot.number, vehicle_type_id: @slot.vehicle_type_id } }
    end
  ...
  test "should update slot" do
    patch slot_url(@slot), params: { slot: { number: @slot.number, vehicle_type_id: @slot.vehicle_type_id } }
